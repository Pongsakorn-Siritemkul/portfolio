...
const AboutCard = () => {
  return (
    <div className="card" style={{ padding: '24px' }}>
      <h2 style={{ fontSize: '20px', margin: '0 0 16px 0' }}>ABOUT ME</h2>
      
      <p style={{ lineHeight: '1.6', color: 'var(--text-main)', marginBottom: '16px', fontSize: '16px' }}>
      ...
      <p style={{ lineHeight: '1.6', color: 'var(--text-main)' , fontSize: '16px'}}>
